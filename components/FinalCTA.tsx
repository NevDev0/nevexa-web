    ...
    <>
      <section className="w-full bg-black px-4 py-16 text-white">
        <div className="mx-auto w-full max-w-3xl text-center">
          {/* Label */}
          <p className="mb-6 text-sm font-semibold uppercase tracking-[0.30em] text-neutral-300">
            Contact
          </p>
          ...
          {/* Sous-texte léger (optionnel, peut être supprimé si tu veux ultra sec) */}
        ...
        >
          ...
          >
            ...
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-neutral-300">
            ...
            <div className="flex flex-col gap-3 md:flex-row">
              ...
              <Link
                ...
                className="flex flex-1 items-center gap-3 rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-200 transition-colors hover:bg-emerald-500/20"
              >
                {/* Icône WhatsApp */}
                <span className="flex h-9 w-9 items-center justify-center rounded-full border border-emerald-400/40">
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 32 32"
                    className="h-4 w-4"
