  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl pb-16 sm:pb-20">
        ...
        {/* Grid — gap-3 mobile, gap-6 desktop / p-5 mobile, p-7 desktop */}
          ...
          {whatOthersWontTellYou.dossierItems.map((item, index) => {
            ...
            return (
              <div
                ...
                className={`group relative cursor-pointer overflow-hidden rounded-lg bg-[#0a0a0a] p-5 md:p-7 transition-all ${
              ...
              >
                ...
                <div
                  ...
                  } ${isRevealed ? "text-white/[0.015]" : "text-transparent"} ${
                    isActive ? "scale-110 rotate-[-3deg] !text-[#5A0F14]/[0.08]" : "scale-100 rotate-0"
                  }`}
                  style={{
                ...
                <div className="relative z-[2]">
                  ...
                  <p
                    ...
                    style={{ transitionDelay: isRevealed ? "850ms" : "0ms" }}
                  >
                    {item.problem}
                  </p>
