...
export const partnershipHeroCopy = {
    ...
    subtitle:
      "Join a selective network of automotive professionals who connect qualified buyers with premium North American vehicles.",
    clarification:
  ...
  export const howItWorksCopy = {
    ...
    steps: [
      ...
      {
        id: "step-2",
        label: "Step 2: Introduce a Qualified Lead",
        details: [
          "You identify a serious buyer in your network",
          "You introduce them to Nevexa (via WhatsApp or email)",
          "Provide basic context (budget, vehicle type, timeline)",
        ],
      },
      {
        id: "step-3",
        label: "Step 3: Step Back",
        details: [
          "Nevexa takes over the entire process",
          "We handle sourcing, inspection, pricing, and logistics",
          "You are kept informed of major milestones",
        ],
      },
      {
        id: "step-4",
        label: "Step 4: Vehicle Delivered",
        details: [
      ...
      {
        id: "step-5",
        label: "Step 5: Commission Paid",
        details: [
          "You receive commission within 30 days of delivery",
          "Payment via wire transfer or Mobile Money",
        ],
      },
    ],
  
    importantNotes: [
      "No real-time tracking dashboard (V1)",
      "No follow-up calls with Nevexa required",
      "No post-introduction negotiation",
    ],
  };
  ...
  // ============================================
  // SECTION 6 — APPLY FOR PARTNERSHIP
  // ============================================
